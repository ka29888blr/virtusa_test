...
public class InputProcessor{
	...
	static Map<String, Float> tokenIntegerValue = new LinkedHashMap<String, Float>(); //{pish=10.0, tegj=50.0, prok=5.0, glob=1.0}
	static Map<String, String> questionAndReply = new LinkedHashMap<String, String>();  //{how much is pish tegj glob glob ?, how many Credits is glob prok Iron ?}
	...
	static Map<String, Float> elementValueList = new LinkedHashMap<String, Float>(); //{Gold=14450.0, Iron=195.5, Silver=17.0}
	...
	private static void deCodeMissingQuery(String query){
		...
		for (int i = 0; i < array.length; i++) {
			String elementName = array[i].toLowerCase();
